package com.example.crud.configuration.crud.string.service;
...
public abstract class AbstractServiceImpl<E extends AbstractEntityString, R extends AbstractRepositoryString<E>> implements AbstractServiceString<E> {
    ...
    public E findById(String id) throws FindException {
